!function(i){"use strict"
    i.widget("sjaakp.cropper",{options:{aspectRatio:1,margin:40,diagonal:300,minSize:240,zoomMax:3,sliderPosition:"bottom",sliderOptions:{}},scale:1,zoom:1,crop:!0,loaded:!1,loadFile:function(i){var t,e,s=this
        ...
        this.previewSize={width:o,height:h},this.preview.css(this.previewSize),"horizontal"===this.slider.slider("option","orientation")?this.slider.width(o):this.slider.height(h)},_calcScale:function(){var i=this.previewSize.width-2*this.options.margin,t=this.previewSize.height-2*this.options.margin,e=Math.max(i/this.nativeSize.width,t/this.nativeSize.height)
        ...
        this.options.minSize>0&&(i=this.options.aspectRatio>=1?this.previewSize.width:this.previewSize.height,i-=2*this.options.margin,i/=this.scale,t=i/this.options.minSize),this.zoom>t&&(this.zoom=Math.max(t,1),this._setImgSize()),t>1?this.slider.slider("option","max",t).slider("enable"):this._reset()},_setMargin:function(){this.overlay.css({borderWidth:this.options.margin})},_setImgPosition:function(i){var t=this.options.margin
